...
function prueba(c) { //c es un parámetro de la función prueba. LOCAL.
    ...
    if(c === 3){
        ...
        console.log('c dentro del if vale: ' + c); // lo que sea que le pasen al parametro c de funcion prueba prueba(3), c es 3, prueba(8) c es 8
        console.log('d dentro del if vale: ' + d); // 4 es local a la funcion
...
//Ejemplo de Lucas, funcion poco clara pero funciona igual, abajo refaction, como deberia estar BIEN ESCRITA
/*
...
let mesesVividos;
let anioNacimiento = Number(prompt('En que anio naciste?'));
let mesNacimiento = Number(prompt('En que mes naciste?'));

console.log(
    'Tenes ' + calcularMesesVividos(mesesVividos) + 'meses vividos'
);
*/

//REFACTION BIEN ESCRITA
...
console.log(
    'Tenes ' + calcularMesesVividos(2022, anioNacimiento, mesNacimiento) + 'meses vividos'
);