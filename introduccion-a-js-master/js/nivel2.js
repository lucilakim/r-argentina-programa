...
/*
    ...
    Podes guardar cualquier cantidad de valores dentro. 
    Y también cualquier tipo de valores: números, cadenas, objetos, incluso
    otros Arrays.
...
const comidasFavoritas = ['Asado', 'Pollo frito', 'Milanesas', 'Muzarelitas'];
...
/*
    ...
    Es útil mantener todos estos valores en un solo lugar. 
    Pero, y si queremos utilizar solo 1 elemento del array?

    Podemos sacarlos usando 'notación de corchetes'. 
    Gracias a un tipo llamado Edsger Dijkstra *, 
...
// TAREA: Obtené el tercer elemento de tu array comidasFavoritas 
// e imprimilo utilizando console.log.
...
/*
    ...
    También podemos reemplazar los valores dentro de los arrays 
...
// TAREA: Toma tu array de comidasFavoritas 
// y reemplaza el primer valor con cualquier otra cosa.

//console.log(comidasFavoritas);
comidasFavoritas[0] = 'Ramen';
...
    no nos gusta repetir las mismas aburridas acciones una y otra vez, 
    ...
    Cada iteración (ciclo) debe tener tres cosas principales:
     - un punto de partida
...
/*
    ...
    El bucle 'While' hará una acción para siempre 
...
// TAREA: Usando un bucle 'while',
// decile a tu computadora que registre los números de
// diez a uno.
...
// que tome como promedio un array
