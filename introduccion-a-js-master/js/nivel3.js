...
nuestroTitulo.textContent = "Nuevo Titulo cambiado con textContent"
...
const imagenSrc = document.querySelector('img');
imagenSrc.src = "img/kittens.jpeg"
...
subtitulo.style.fontWeight = 400;
...
const nodoDivImg = document.querySelector("#logo");
const nuevaImagen = document.createElement('img');
nuevaImagen.src = "img/woman_bw.jpg";
nodoDivImg.appendChild(nuevaImagen);
