...
/*
    ...
    Para crear (o mejor dicho DECLARAR) una variable usamos 'let', así:
    ...
    Para darle un valor a nuestra variable (o mejor dicho ASIGNAR un valor), 
    usamos el signo '='.
...
// Crear 2 variables nuevas, una con tu nombre, 
//la segunda con tu edad. Dales un nombre apropriado y
...
/*
    ...
    Hay muchos 'operadores' diferentes en programación. 
    Veamos los operadores aritéticos ahora.
    JavaScript incluye operadores estándares (+, -, /, *) 
    que se pueden usar para hacer operaciones matemáticas.
    ...
    Consejo: Fijate que no pusimos 1 y 3 entre comillas 
    porque queremos que se interpreten como números, no como texto.
*/
...
/*
    ...
    Esta función va a tomar sólo 1 argumento y va a devolver 
    (RETURN) el argumento multiplicado por 2.

    Nuestra función acaba de ser DEFINIDA, 
    pero no se va a ejecutar/correr si no la 'llamamos'.

    Para llamar/ejecutar la función usamos el siguiente formato:

    nombreFuncion(10); // nombreDeFuncion(argumento1);

    Esto va a a llamar nuestra funcion con el argumento 10, 
    y nuestra función va a devolver 20 (10 * 2).
    Para poder ver lo que nuestra  función devuelve, 
    podemos pasársela como argumento a console.log.
...
// Consejo: Sabías que en vez de pasar los números directamente 
//a tu función podés crear variables con esos números
...
// Preguntar el salario mensual y calcuar el anual
// diario...semanal, por hora. etc.
    ...
    const salarioMensual = Number(
        prompt('Cuál es tu salario mensual?')
    );
    ...
    //CONTINUA EN TAREA 1, con SCOPE
*/
// Consejo: Dejá las funciones como están, no las comentes, 
//las vamos a usar de nuevo(la de sumar y restar).
...
/*
    ...
    Qué pasa si en nuestro programa queremos decidir 
    sobre qué función debería ejecutarse? 
    ...
    Le podés dar una condición 'if' a una máquina para que haga una decisión 
    acerca de qué parte del código tiene que ejecutarse.
    ...
    Por ejemplo, si tenemos un número, lo podemos compa
    rar con algo.
...
/*
    ...
    a los operadores aritméticos de JavaScript (+, -, *, /). 
    Ahora es momento de presentar el siguiente set de operadores, 
    los 'Operadores de comparación'. Son usados para comparar valores:
...
// No se olviden de hacer un console.log para ver el resultado!
        ...
        // const operator = prompt('Ingrese + para sumar o - para restar 1 y 2');
        // const number1 = 1;
        // const number2 = 2;
        ...
        /*
        console.log( 
            'El resultado de ' + number1 + ' ' + operator + ' ' + number2 + ' es ' + result
        );*/

        //https://developer.mozilla.org/es/docs/web/javascript/reference/template_literals
       // el console.log bien hecho
        /*console.log(
            `El resultado de ${number1} ${operator} ${number2} es ${result}`
        );*/

        /* el console.log con interpolacion de funcion
         console.log(
            `El resultado de ${number1} ${operator} ${number2} es ${add(number1, number2)}`
        );*/
...
/*
    ...
    Bueno, y qué pasa si tenemos 4 operaciones aritméticas en 
    nuestra calculadora? 
...
/*
    const operator = prompt('Ingrese operador (+,-,*,/)');
    const number1 = 10;
    const number2 = 2

let result; //empieza siendo undefined
if (operator === '+') {
    result = add(number1, number2);
} else if (operator === '-') {
    result = subtract(number1, number2);
    ...
    console.log(`No entiendo el operador ${operator}`);
}

console.log(`El resultado de ${number1} ${operator} ${number2} es ${result}`);
*//*


    Operadores Booleanos
    =================
    Poner un signo de exclamación (!) antes de un valor Booleano 
    nos da el valor OPUESTO.
    Este operador ! se llama el operador "not".
    
    El resultado de una comparación es un valor Booleano, 
    lo podemos guardar en una variable así:
    ...
    También podemos asignar un valor booleano directamente a una variable o constante 
    con las palabras reservadas (keywords) true y false:
